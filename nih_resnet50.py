...
logging.basicConfig(filename="logs/nih_resnet50.log", level=logging.INFO,
...
for epoch in range(num_epochs):
    ...
    if val_auc > best_auc:
        best_auc = val_auc
        torch.save(model.state_dict(), "checkpoints/nih_resnet50_best.pth")
...
# ========== Test ==========
model.load_state_dict(torch.load("checkpoints/nih_resnet50_best.pth", weights_only = True))
