...
logging.basicConfig(filename="logs/nih_vit.log", level=logging.INFO,
...
for epoch in range(num_epochs):
    ...
    if val_auc > best_auc:
        best_auc = val_auc
        torch.save(model.state_dict(), "checkpoints/nih_vit_best.pth")
...
# ========== Test ==========
model.load_state_dict(torch.load("checkpoints/nih_vit_best.pth", weights_only = True))
